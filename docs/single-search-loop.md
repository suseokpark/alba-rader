...
- 종료: **2026-09-26 11:00 Asia/Seoul**. 시작 및 코드 수정 전에 현재 시각 확인. 종료 30분 전부터 새 기능 금지, 최종 회귀·인계만 수행. 종료 시 자동화도 중지한다.
...
- 기존 dirty 변경 보존. 자동 개선 루프는 GitHub push/배포를 포함하지 않는다. 2026-09-25 22:52 KST의 별도 사용자 요청으로 이번 수동 작업의 push/배포만 허용되었다.
...
- 사용자 지정 업체색: **알바몬 주황 / 당근 회색 / 알바천국 검정**. 공식 브랜드색과 다르더라도 이 요구를 따른다.
